 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '4.3.7' );
define( 'AYS_QUIZ_VERSION', '4.3.7' );
         ...
         <div class="ays-notice-banner">
            <div class="navigation-bar">
                <div id="navigation-container">
                    <a class="logo-container" href="https://bit.ly/2nbbHta" target="_blank">
                        <img class="logo" src="<?php echo AYS_QUIZ_ADMIN_URL . '/images/ays_pro.png'; ?>" alt="AYS Pro logo" title="AYS Pro logo"/>
                    </a>
                    <ul id="menu">
                        <li><a class="ays-btn" href="https://bit.ly/2nb6e5g" target="_blank">PRO</a></li>
                        <li><a class="ays-btn" href="https://bit.ly/2lyf6S7" target="_blank">Documentation</a></li>
                        <li><a class="ays-btn" href="https://bit.ly/2mducNh" target="_blank">Rate Us</a></li>
                        <li><a class="ays-btn" href="https://bit.ly/2nbziJW" target="_blank">Demo</a></li>
                        <li><a class="ays-btn" href="https://bit.ly/2m4743W" target="_blank">Support Forum</a></li>
                        <li><a class="ays-btn" href="http://bit.ly/2tLbooO" target="_blank">Take a survey</a></li>
                        <li><a class="ays-btn" href="https://bit.ly/2mdsCuI" target="_blank">Contact us</a></li>
                    </ul>
                </div>
            </div>
         </div>
