                                ...
                                <div class="pro_features">
                                    <div>
                                        <p style="font-size:25px;">
                                            ...
                                            <a href="https://bit.ly/2m4yruI" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                        </p>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-2 ays_theme_image_div" style="padding:0;">
                                        <label class="ays-quiz-theme-item ays-disable-setting">
                                            ...
                                            <img style="width: 80px;" src="<?php echo AYS_QUIZ_ADMIN_URL . '/images/themes/modern_light.PNG' ?>" alt="Modern Light"/>
                                        </label>
                                    </div>
                                    <div class="col-sm-2 ays_theme_image_divs" style="padding:0;">
                                        <label class="ays-quiz-theme-item ays-disable-setting">
                                            <p><?php echo __('Modern Dark',$this->plugin_name)?></p>
                                            <img style="width: 80px;" src="<?php echo AYS_QUIZ_ADMIN_URL . '/images/themes/modern_dark.PNG' ?>" alt="Modern Dark"/>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-5">
                                    <label for='ays_mobile_max_width'>
                                        ...
                                        <a class="ays_help" data-toggle="tooltip" title="<?php echo __('Quiz container max-width for mobile in percentages.',$this->plugin_name)?>">
                                            <i class="ays_fa ays_fa_info_circle"></i>
                                        </a>
                                    </label>
                                </div>
                        ...
                        <div class="pro_features" style="justify-content:flex-end;padding-right:20px;">
                            <div>
                                <p style="font-size:20px;margin:0;">
                                    <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                    <a href="https://bit.ly/2nECwpB" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-sm-12 only_pro" style="padding:10px 0 0 10px;">
                        <div class="pro_features" style="justify-content:flex-end;padding-right:20px;">
                            <div>
                                <p style="font-size:20px;margin:0;">
                                    <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                    <a href="https://bit.ly/2lzyfTT" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                    ...
                    <div class="col-sm-12 only_pro" style="padding:15px;">
                        <div class="pro_features">                            
                            <div>
                                <p style="font-size:20px;margin:0;">
                                    <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                    <a href="https://bit.ly/2nN2Z4z" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                ...
                <div class="only_pro" style="margin-top: 30px;">
                    <div class="pro_features">
                        <div>
                            <p>
                                <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                <a href="https://bit.ly/2lBYUPZ" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                            </p>
                        </div>
                    </div>
                    <div>
                    ...
                    <div class="pro_features" style="align-items: flex-end;justify-content: flex-end;">
                        <div>
                            <p style="margin: 0;margin-bottom: 5px;margin-right: 5px;padding: 4px 8px;font-size: 20px;">
                                <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                <a href="https://bit.ly/2lD2U2E" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                            </p>
                        </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-12">
                        <div class="pro_features">
                            <div>
                                <p>
                                    <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                    <a href="https://bit.ly/2lEtqc0" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="pro_features" style="justify-content:flex-end;">
                            <div style="margin-right:20px;">
                                <p style="font-size:20px;">
                                    <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                    <a href="https://bit.ly/2nH4b9n" target="_blank" title="PRO feature"><?php echo __("PRO version!!!", $this->plugin_name); ?></a>
                                </p>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="col-sm-12" style="padding:20px;">
                            <div class="pro_features" style="justify-content:flex-end;">
                                <div style="margin-right:20px;">
                                    <p style="font-size:20px;">
                                        <?php echo __("This feature available only in ", $this->plugin_name); ?>
                                        <a href="https://bit.ly/2nH4b9n" target="_blank" title="Developer feature"><?php echo __("Developer package!!!", $this->plugin_name); ?></a>
                                    </p>
                                </div>
                            </div>
                            <div class="form-group row">
